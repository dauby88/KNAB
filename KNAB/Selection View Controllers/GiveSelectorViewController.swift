//
//  GiveSelectorViewController.swift
//  KNAB
//
...
class GiveSelectorViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "giveSelectionCell")!
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        UserDefaults.selectedGiveCategoryID = id
        performSegue(withIdentifier: "segueToBudgets", sender: nil)
    }
}
